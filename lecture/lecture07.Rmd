...
- D1 Marital status: Unmarried = 0, Married = 1
- D2 Gender: Men = 0, Women = 1

Group           | $Y_i=\beta_0+\beta_1 D_{1i} + \beta_2 D_{2i} + \epsilon_i$  | $Y_i=\beta_0+\beta_1 D_{1i} + \beta_2 D_{2i} + \beta_3 D_{1i} D_{2i}+ \epsilon_i$ |
----------------|-------------------------------------------------------------|-----------------------------------------------------------------------------------|
Unmarried Men   | $= \beta_0$                                                 | $= \beta_0$                                                                       |
Married Men     | $= \beta_0 + \beta_1$                                       | $= \beta_0 + \beta_1$                                                             |
Unmarried Women | $= \beta_0 + \beta_2$                                       | $= \beta_0 + \beta_2$                                                             |
Married Women   | $= \beta_0 + \beta_1 + \beta_2$                             | $= \beta_0 + \beta_1 + \beta_2 + \beta_3$                                         |
